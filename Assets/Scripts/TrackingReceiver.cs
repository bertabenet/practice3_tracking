...
public class TrackingReceiver : MonoBehaviour
{
    ...
    /*
     * Handles the messages that are comming from the library
     */
    protected void MessageReceived(OSCMessage message)
    {
        ...
        for (int i = 0; i < list.Count; i += 3)
        {
            ...
            if (val1.Type == OSCValueType.Float) position.x = val1.FloatValue - 250;      // this is just to center the positions in 0,0,0
